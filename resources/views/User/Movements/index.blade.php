                        ...
                        <tbody>
                            @foreach ($movements as $movement)
                                <tr>
                                    ...
                                    <div class="modal fade" id="modalModifierMouvement{{ $movement->id }}"
                                                ...
                                                <form method="POST" action="#">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="col-md-6">
                                                                <label
                                                                    for="movement_type_id_{{ $movement->movementType->id }}"
                                                                ...
                                                                <select class="form-select"
                                                                    ...
                                                                    <option value="{{ $movement->movementType->id }}"
                                                                        selected>{{ $movement->movementType->name }}
                                                                    </option>
                                                            ...
                                                            <div class="col-md-4">
                                                                <label for="quantity_{{ $movement->id }}"
                                                            ...
                                                            <div class="col-md-4">
                                                                <label for="movement_date_{{ $movement->id }}"
                                                                    class="form-label">Date</label>
                                                                <input type="date" class="form-control"
                                                                    id="movement_date_{{ $movement->id }}"
                                                                    name="movement_date"
                                                                    value="{{ $movement->movement_date }}" required>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="user_id_{{ $movement->user->id }}"
                                                                    class="form-label">Effectué
                                                                    par</label>
                                                                <select class="form-select"
                                                                    id="user_id_{{ $movement->user->id }}"
                                                                    name="user_id">
                                                                    <option value="{{ $movement->user->id }}"
                                                                        selected>{{ $movement->user->name }}
                                                                    </option>
                                    ...
                                    <div class="modal fade" id="modalSupprimerMouvement{{ $movement->id }}"
                                        tabindex="-1" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control" id="movement_date_ajout"
